...
![图片](images/661455/6e3a4e608ddf40ec0818e3ab79563061.png)
...
![图片](images/661455/4ecd1d64eac5bdb92cbb27045070a7e3.png)
...
前端的整套代码我会统一放在GitHub上（正在完善中，后续统一上传），你可以下载下来之后使用HBuilderX来运行。这里我们主要来讲讲这段代码里面的重点内容。
